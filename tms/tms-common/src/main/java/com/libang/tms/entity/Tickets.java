...
public class Tickets implements Serializable {
    public static final String TICKETS_STATE_IN_STORE = "已入库";
    public static final String TICKETS_STATE_OUT_STORE = "已下发";
    public static final String TICKETS_STATE_SALE = "已销售";
    public static final String TICKETS_STATE_LOST = "已挂失";
    public static final String TICKETS_STATE_OUT_DATE = "已过期";
